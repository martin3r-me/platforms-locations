                ...
                'locations' => [
                    ...
                    'items' => [
                        ...
                        'properties' => [
                            ...
                            'mehrfachbelegung' => ['type' => 'boolean'],
                            'adresse' => ['type' => 'string', 'description' => 'Wird per Default via Nominatim geocoded -> setzt latitude/longitude. Mit geocode=false oder expliziten lat/lng wird der Lookup uebersprungen.'],
                            ...
                            'geocode' => ['type' => 'boolean', 'description' => 'Default true. false unterdrueckt den Nominatim-Lookup.'],
