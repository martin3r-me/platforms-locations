...
class BulkUpdateLocationsTool implements ToolContract, ToolMetadataContract
{
    ...
    public function getSchema(): array
    {
        $fields = [
            ...
            'adresse'          => ['type' => 'string', 'description' => 'Bei Aenderung wird per Default via Nominatim geocoded -> Lat/Lng werden neu gesetzt. Mit geocode=false oder expliziten lat/lng wird der Lookup uebersprungen.'],
            'latitude'         => ['type' => 'number', 'description' => 'WGS84-Breitengrad. Wenn explizit gesetzt, kein Geocoding.'],
            'longitude'        => ['type' => 'number', 'description' => 'WGS84-Laengengrad. Wenn explizit gesetzt, kein Geocoding.'],
            'geocode'          => ['type' => 'boolean', 'description' => 'Default true. false unterdrueckt den Nominatim-Lookup beim Setzen einer neuen Adresse.'],
